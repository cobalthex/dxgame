...
#include "Engine/Graphics/Textures/Formats/DDSTextureLoader.hpp"
#include "Engine/Graphics/Textures/Formats/StbImage.hpp"
...
{
	if (StringOps::EndsWith(File, L".dds")) //load with DDS loader
	{
		ID3D11Resource* tex;
		Sys::ThrowIfFailed
		(
