...
{
public:
	Mesh() : startVertex(0), vertexCount(0), startIndex(0), indexCount(0) { }
	Mesh(size_t StartVertex, size_t VertexCount, size_t StartIndex, size_t IndexCount) : startVertex(StartVertex), vertexCount(VertexCount), startIndex(StartIndex), indexCount(IndexCount) { }
