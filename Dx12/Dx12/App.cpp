...
void App::Load(Platform::String^ entryPoint)
{
	if (main == nullptr)
	{
		main = std::unique_ptr<Dx12Main>(new Dx12Main());
	}
}
...
{
	if (deviceResources != nullptr && deviceResources->IsDeviceRemoved())
	{
	...
	if (deviceResources == nullptr)
	{
		...
		deviceResources->SetWindow(CoreWindow::GetForCurrentThread());
		main->CreateRenderers(deviceResources);
	}
